...
export class DriverApi extends BaseLoopBackApi {
  ...
  public getCurrent(filter: LoopBackFilter = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() + "/Drivers" + "/:id";
   ...
   * call to {@link sdk.Driver#login} or
   * {@link sdk.Driver#getCurrent}. Return null when there
  ...
  /**
   * @name sdk.Driver#isAuthenticated
   *
